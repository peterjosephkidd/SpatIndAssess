...
if(dir.exists(surveydata.path2) == FALSE){
  dir.create(surveydata.path2)
}
```
...
surveydata.path2 <- paste0(getwd(), "/Data/Survey Data/")

### Create directory for NS-IBTS
if(dir.exists(paste0(surveydata.path2, "NS-IBTS")) == FALSE){
  dir.create(paste0(surveydata.path2, "NS-IBTS"))
}
save(ns_ibts.hh, file = paste0(surveydata.path2, "NS-IBTS/ns_ibts.hh.rda"))
save(ns_ibts.hl, file = paste0(surveydata.path2, "NS-IBTS/ns_ibts.hl.rda"))
save(ns_ibts.ca, file = paste0(surveydata.path2, "NS-IBTS/ns_ibts.ca.rda"))

#### Processing NS-IBTS
ns_ibts.data <- prepsurveydata(ns_ibts.hh, ns_ibts.hl, ns_ibts.ca, ices_rect)
save(ns_ibts.data, file = paste0(surveydata.path2, "NS-IBTS/ns_ibts.data.rda"))
```
...
#### Save
### Create directory
if(dir.exists(paste0(surveydata.path2, "BTS")) == FALSE){
  dir.create(paste0(surveydata.path2, "BTS"))
}
save(bts.hh, file = paste0(surveydata.path2, "BTS/bts.hh.rda"))
save(bts.hl, file = paste0(surveydata.path2, "BTS/bts.hl.rda"))
save(bts.ca, file = paste0(surveydata.path2, "BTS/bts.ca.rda"))

#### Processing BTS
bts.data <- prepsurveydata(bts.hh, bts.hl, bts.ca, ices_rect)
### Save
save(bts.data, file = paste0(surveydata.path2, "BTS/bts.data.rda"))
```
...
### Load BTS
load(paste0(surveydata.path2, "BTS/bts.hh.rda"))
load(paste0(surveydata.path2, "BTS/bts.hl.rda"))
load(paste0(surveydata.path2, "BTS/bts.ca.rda"))
...
#### Save
### Create directory
if(dir.exists(paste0(surveydata.path2, "BTS-Isis")) == FALSE){
  dir.create(paste0(surveydata.path2, "BTS-Isis"))
}
save(bts_isis.hh, file = paste0(surveydata.path2, "BTS-Isis/bts_isis.hh.rda"))
save(bts_isis.hl, file = paste0(surveydata.path2, "BTS-Isis/bts_isis.hl.rda"))
save(bts_isis.ca, file = paste0(surveydata.path2, "BTS-Isis/bts_isis.ca.rda"))

#### Processing BTS-Isis
bts_isis.data <- prepsurveydata(bts_isis.hh, bts_isis.hl, bts_isis.ca, ices_rect)
### Save
save(bts_isis.data, file = paste0(surveydata.path2, "BTS-Isis/bts_isis.data.rda"))
```
...
### Create directory
if(dir.exists(paste0(surveydata.path2, "UK-BTS")) == FALSE){
  dir.create(paste0(surveydata.path2, "UK-BTS"))
}
save(uk_bts.hh, file = paste0(surveydata.path2, "UK-BTS/uk_bts.hh.rda"))
save(uk_bts.hl, file = paste0(surveydata.path2, "UK-BTS/uk_bts.hl.rda"))
save(uk_bts.ca, file = paste0(surveydata.path2, "UK-BTS/uk_bts.ca.rda"))

#### Processing UK-BTS
uk_bts.data <- prepsurveydata(uk_bts.hh, uk_bts.hl, uk_bts.ca, ices_rect)
### Save
save(uk_bts.data, file = paste0(surveydata.path2, "UK-BTS/uk_bts.data.rda"))
```
...
### save data
# Create directory
if(dir.exists(paste0(surveydata.path2, "SNS")) == FALSE){
  dir.create(paste0(surveydata.path2, "SNS"))
}
save(sns.hh, file = paste0(surveydata.path2, "SNS/sns.hh.rda"))
save(sns.hl, file = paste0(surveydata.path2, "SNS/sns.hl.rda"))
save(sns.ca, file = paste0(surveydata.path2, "SNS/sns.ca.rda"))

### Processing SNS
sns.data <- prepsurveydata(sns.hh, sns.hl, sns.ca, ices_rect)
### Save
save(sns.data, file = paste0(surveydata.path2, "SNS/sns.data.rda"))
```
...
#### Save
### Create directory
if(dir.exists(paste0(surveydata.path2, "DYFS")) == FALSE){
  dir.create(paste0(surveydata.path2, "DYFS"))
}
save(dyfs.hh, file = paste0(surveydata.path2, "DYFS/dyfs.hh.rda"))
save(dyfs.hl, file = paste0(surveydata.path2, "DYFS/dyfs.hl.rda"))
save(dyfs.ca, file = paste0(surveydata.path2, "DYFS/dyfs.ca.rda"))

#### Processing DYFS
dyfs.data <- prepsurveydata(dyfs.hh, dyfs.hl, dyfs.ca, ices_rect)
### Save
save(dyfs.data, file = paste0(surveydata.path2, "DYFS/dyfs.data.rda"))
```
...
#### Save
### Create directory
if(dir.exists(paste0(surveydata.path2, "FR-CGFS")) == FALSE){
  dir.create(paste0(surveydata.path2, "FR-CGFS"))
}
save(fr_cgfs.hh, file = paste0(surveydata.path2, "FR-CGFS/fr_cgfs.hh.rda"))
save(fr_cgfs.hl, file = paste0(surveydata.path2, "FR-CGFS/fr_cgfs.hl.rda"))
save(fr_cgfs.ca, file = paste0(surveydata.path2, "FR-CGFS/fr_cgfs.ca.rda"))

#### Processing FR-CGFS
fr_cgfs.data <- prepsurveydata(fr_cgfs.hh, fr_cgfs.hl, fr_cgfs.ca, ices_rect)
### Save
save(fr_cgfs.data, file = paste0(surveydata.path2, "FR-CGFS/fr_cgfs.data.rda"))
```
...
#### Save
### Create directory
if(dir.exists(paste0(surveydata.path2, "SWC-IBTS")) == FALSE){
  dir.create(paste0(surveydata.path2, "SWC-IBTS"))
}

save(swc_ibts.hh, file = paste0(surveydata.path2, "SWC-IBTS/swc_ibts.hh.rda"))
save(swc_ibts.hl, file = paste0(surveydata.path2, "SWC-IBTS/swc_ibts.hl.rda"))
save(swc_ibts.ca, file = paste0(surveydata.path2, "SWC-IBTS/swc_ibts.ca.rda"))

#### Processing SWC-IBTS
swc_ibts.data <- prepsurveydata(swc_ibts.hh, swc_ibts.hl, swc_ibts.ca, ices_rect)
### Save
save(swc_ibts.data, file = paste0(surveydata.path2, "SWC-IBTS/swc_ibts.data.rda"))
```
...
#### Save
### Create directory
if(dir.exists(paste0(surveydata.path2, "SCOWCGFS")) == FALSE){
  dir.create(paste0(surveydata.path2, "SCOWCGFS"))
}
save(scowcgfs.hh, file = paste0(surveydata.path2, "SCOWCGFS/scowcgfs.hh.rda"))
save(scowcgfs.hl, file = paste0(surveydata.path2, "SCOWCGFS/scowcgfs.hl.rda"))
save(scowcgfs.ca, file = paste0(surveydata.path2, "SCOWCGFS/scowcgfs.ca.rda"))

#### Processing SCOWCGFS
scowcgfs.data <- prepsurveydata(scowcgfs.hh, scowcgfs.hl, scowcgfs.ca, ices_rect)
### Save
save(scowcgfs.data, file = paste0(surveydata.path2, "SCOWCGFS/scowcgfs.data.rda"))
```
...
#### Save
### Create directory
if(dir.exists(paste0(surveydata.path2, "IE-IGFS")) == FALSE){
  dir.create(paste0(surveydata.path2, "IE-IGFS"))
}

save(ie_igfs.hh, file = paste0(surveydata.path2, "IE-IGFS/ie_igfs.hh.rda"))
save(ie_igfs.hl, file = paste0(surveydata.path2, "IE-IGFS/ie_igfs.hl.rda"))
save(ie_igfs.ca, file = paste0(surveydata.path2, "IE-IGFS/ie_igfs.ca.rda"))

#### Processing IE-IGFS
ie_igfs.data <- prepsurveydata(ie_igfs.hh, ie_igfs.hl, ie_igfs.ca, ices_rect)
### Save
save(ie_igfs.data, file = paste0(surveydata.path2, "IE-IGFS/ie_igfs.data.rda"))
```
